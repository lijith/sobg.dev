...
return [
	...
	'routing' => [
		...
		'member_session_destroy' => ['route' => 'member.login'],
		...
		'member_change_password' => ['route' => 'member.profile.show'],
		'member_registration_activated' => ['route' => 'member.profile.show'],
		'registration_activated' => ['route' => 'home'],
		'registration_resend' => ['route' => 'home'],
		'registration_reset_triggered' => ['route' => 'member.reset.info'],
		'registration_reset_invalid' => ['route' => 'member.reset.info'],
		'registration_reset_complete' => ['route' => 'member.reset.info'],
