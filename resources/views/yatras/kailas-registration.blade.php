		      ...
		      <div class="col-md-12">
		        ...
		        <form class="form-horizontal" method="POST" action="{{ route('Registration.store') }}">
		          ...
		          <div class="form-group {{ ($errors->has('blood-group')) ? 'has-error' : '' }}">
		            ...
		            <div class="col-sm-8">
		              <input type="text" placeholder="Blood Group" class="form-control" name="blood-group">
		            </div>
		          </div>
		          <div class="form-group {{ ($errors->has('passport-name')) ? 'has-error' : '' }}">
		            <label class="col-sm-4 control-label">Name as in Passport</label>
		            <div class="col-sm-8">
		              <input type="text" placeholder="Name as in Passport" class="form-control" name="passport-name">
		            </div>
		          </div>
		          <div class="form-group {{ ($errors->has('passport-number')) ? 'has-error' : '' }}">
		            <label class="col-sm-4 control-label">Passport Number</label>
		            <div class="col-sm-8">
		              <input type="text" placeholder="Passport Number" class="form-control" name="passport-number">
		            </div>
		          </div>
		          <div class="form-group">
		            <label class="col-sm-4 control-label">Persons Accompanying You</label>
		            <div class="col-sm-8">
		              <textarea placeholder="Persons Accompanying You" class="form-control" name="accompanying-persons"></textarea>
		            </div>
		          </div>
		          ...
		          <div class="form-group {{ ($errors->has('address-line-1')) ? 'has-error' : '' }}">
		            ...
		            <div class="col-sm-8">
		              <input type="text" placeholder="Address" class="form-control" name="address-line-1">
		          ...
		          <div class="form-group {{ ($errors->has('address-line-2')) ? 'has-error' : '' }}">
		            ...
		            <div class="col-sm-8">
		              <input type="text" placeholder="Address (Line 2)" class="form-control" name="address-line-2">
		          ...
		          <div class="form-group {{ ($errors->has('contact-mobile')) ? 'has-error' : '' }}">
		            ...
		            <div class="col-sm-8">
		              <input type="text" placeholder="Mobile Number" class="form-control" name="contact-mobile">
		            </div>
		          </div>
		          <div class="form-group {{ ($errors->has('contact-landline')) ? 'has-error' : '' }}">
		            <label class="col-sm-4 control-label">Landline Number</label>
		            <div class="col-sm-8">
		              <input type="text" placeholder="Landline Number" class="form-control" name="contact-landline">
		            </div>
		          </div>
		          ...
		          <div class="form-group">
		            ...
		            <div class="col-sm-8">
		              <textarea placeholder="Special Requirements" class="form-control" name="special-requirement"></textarea>
		            </div>
		          </div>
