<!--eshop side bar -->
<div class="col-md-4 col-md-pull-8 side-cart">
	<div class="shadow">
		...
		<div class="cart-wrap">
			...
			<div class="eshop-items">
				<ul>
					<li><a href="{{route('dvd')}}" class="{{($sub_page_active == 'dvd')?'select':''}}">Dvds</a></li>
					<li><a href="{{route('vcd')}}" class="{{($sub_page_active == 'vcd')?'select':''}}">VCDs</a></li>
					<li><a href="{{route('acd')}}" class="{{($sub_page_active == 'acd')?'select':''}}">Audio CDs</a></li>
					<li><a href="{{route('mp3')}}" class="{{($sub_page_active == 'mp3')?'select':''}}">MP3s</a></li>
					<li><a href="{{route('books')}}" class="{{($sub_page_active == 'book')?'select':''}}">Books</a></li>
				</ul>
			</div><!-- /.eshop-items -->
