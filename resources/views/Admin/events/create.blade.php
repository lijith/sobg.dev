...
<div class="row">
    ...
    <section class="panel">
      ...
      <div class="panel-body">
	        ...
	        <form method="POST" action="{{ route('events.store') }}" accept-charset="UTF-8">
            ...
            <div class="form-group {{ ($errors->has('excerpt')) ? 'has-error' : '' }}">
                <label>Excerpt</label>
                <textarea rows="6" class="form-control" placeholder="Excerpt" name="excerpt">{{ Input::old('excerpt') }}</textarea>
            ...
            <div class="form-group {{ ($errors->has('details')) ? 'has-error' : '' }}">
                ...
                <textarea rows="6" class="form-control ckeditor" placeholder="Detail" name="details">{{ Input::old('details') }}</textarea>
